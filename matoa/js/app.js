...
***************************************************************************** */
    ...
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest(".model-product__button")) {
            addToCart();
            e.preventDefault();
        }
    }
    function addToCart() {
        const speed = 1e3;
        const headerCart = document.querySelector(".action-header__cart");
        const headerCartQuantity = headerCart.querySelector("span");
        const productImage = document.querySelector(".image-product__slide.swiper-slide-active img");
        document.querySelector(".content-product__title").innerHTML;
        document.querySelector(".content-product__old-price") && document.querySelector(".content-product__old-price").innerHTML;
        document.querySelector(".content-product__price").innerHTML;
        ...
        setTimeout((() => {
            imageFlyBlock.style.cssText = `\n\t\t\t\ttop: calc(${headerCart.getBoundingClientRect().top}px + 20px);\n\t\t\t\tleft: calc(${headerCart.getBoundingClientRect().left}px + 20px);\n\t\t\t\twidth: 0;\n\t\t\t\theight: 0;\n\t\t\t\topacity: 0.3;\n\t\t\t\ttransition: all ${speed}ms;\n\t\t\t`;
        }), 5);
        setTimeout((() => {
